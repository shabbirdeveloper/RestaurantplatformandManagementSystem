...
function WebsiteContentPage({ state, commit, notify }) {
  ...
  const saveHomepage = () => {
    ...
    const tickerSettings = {
      ...
      tickerSpeed: Math.min(60, Math.max(8, Number(draft.tickerSpeed) || 18)),
