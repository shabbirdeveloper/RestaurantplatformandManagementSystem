...
function WebsiteContentPage({ state, commit, notify }) {
  ...
  const saveHomepage = () => {
    ...
    commit({ homepage: { ...draft, ...typography, stats: normalizeStats(draft.stats), heroSlides: slides, historyMilestones } });
    notify('Homepage content, hero slides, and history timeline published successfully.');
  };
