...
function makeNewRecord(resource, rows = [], categories = []) {
  ...
  if (resource === 'gallery') return { id, title: 'New gallery image', category: 'Food', branch: 'All branches', image: '', alt: '', storagePath: '', status: 'Draft', featured: false, uploadedAt: 'Today' };
